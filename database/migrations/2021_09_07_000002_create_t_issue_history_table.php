...
class CreateTIssueHistoryTable extends Migration {
	...
	public function up()
	{
		Schema::create('t_issue_history', function(Blueprint $table)
		{
			$table->bigInteger('id', true);
            $table->integer('issue_id');
            $table->integer('project_id');
            $table->integer('history_index');
