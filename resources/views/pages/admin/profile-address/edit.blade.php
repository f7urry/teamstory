...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="#" class="btn-save" data-form="#formAdd" data-action="{{url('/profileaddress/'.$address->id)}}"><i class="fa fa-check"></i> Update</a></li>
    <li class="breadcrumb-item"><a href="{{url('/profileaddress/default/'.$address->id)}}"><i class="fa fa-check"></i> Set Default</a></li>
</ol>
<div class="row">
    <div class="col-lg-4">
        <div class="card">
                ...
                <form method="post" class="row card-body" name="formAdd" id="formAdd">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <select name="province_id" id="province" class="form-control col-12">
                                <option value="{{$address->province->id}}">{{$address->province->location}}</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>City</label>
                            <select name="city_id" id="city" class="form-control col-12">
                                <option value="{{$address->city->id}}">{{$address->city->location}}</option>
                            </select>
                        </div>
                        <div class="form-group">
