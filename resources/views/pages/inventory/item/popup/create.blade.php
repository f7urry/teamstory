...
@section("content")
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#" data-form="#popupFormAdd" data-action="{{url('/popup/item')}}" class="btn-save"><i class="fa fa-check"></i> Simpan</a></li>
</ol>
<form class="form-popup" name="formData" method="post" id="popupFormAdd" enctype="multipart/form-data">
    {{csrf_field()}}
